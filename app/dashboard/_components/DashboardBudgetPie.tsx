...
export function BudgetPieChart({
  ...
  return (
    ...
    >
        ...
        {rows.map((r, i) => {
          ...
          return (
            <div
              key={r.categoryId}
              className={cn(
                "px-3 py-2.5 transition-colors duration-200 cursor-pointer",
                isActive ? "bg-muted/60 overflow-auto" : "hover:bg-muted/40",
              )}
              onMouseEnter={() => {
      ...
      {/* ── Donut chart ───────────────────────────────────────────────── */}
      <div className="border rounded-xl relative flex items-center justify-center">
